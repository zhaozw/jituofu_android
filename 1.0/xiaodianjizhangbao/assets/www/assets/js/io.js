...
define(function (require, exports, module){
    ...
    IO.prototype = {
        ...
        success: function (data){
	        ...
	        console.log("成功: "+this.cfg.url, JSON.stringify(data));
	   
            this.cfg.on.success.call(this, data);
        },
        error: function (data){
            this.cleanerTimerouter();
			console.log("失败: "+this.cfg.url + JSON.stringify(data));
        },
        ...
        send: function (){
            ...
            if(!user && this.cfg.url.indexOf("login") < 0 && this.cfg.url.indexOf("register") < 0
                && this.cfg.url.indexOf("help") < 0 && this.cfg.url.indexOf("getProductInfo") < 0
                && this.cfg.url.indexOf("forgot") < 0){
                return self.success({
                    bizCode: 0,
                    memo: "没有用户信息",
                    data: []
            ...
            if(!user){
                user = {username: "username", hash_pw: "hash_pw"};
            }
