...
public class UICashierProductSearch extends BaseUiAuth implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.page_cashier_products_search);
		...
		if (resultStatus == 100) {
			...
			case C.TASK.gettypes:
				...
				if (initQuery && types.length() <= 0) {
					...
					((LinearLayout) searchView.getParent())
	...
	private void onBind() {
		...
		searchView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				bundle.putString("from", C.COMMON.cashier);
				forwardForResult(UIProductSearchList.class, UICashier.TAG,
						bundle);
			}
		});
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v,
				...
				forwardForResult(UIWareHouseParentTypeDetail.class,
	...
	private void updateView() {
		titleView.setText(R.string.CASHIER_SELECT_PRODUCT);
	}
